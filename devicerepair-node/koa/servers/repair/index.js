...
//设置导航权限
    this.devicerepairNav = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + '/devicerepair/v1/setButtonPermission',//2017-06-12
            headers:{
    ...
    this.devicerepairper = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + '/devicerepair/v1/sonPermission',//2017-06-10
            headers:{
                userToken:argvs.userToken
            }
        };
    ...
    this.guidePermission = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/devicerepair/v1/guidePermission?guideAddrStatus=`+argvs.name,//2017-06-08
            headers:{
                userToken:argvs.userToken
            }
        };
    ...
    this.deviceList = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/devicerepair/v1/list${urlEncode(argvs,true)}`,//2017-06-07
            headers:{
                userToken:argvs.userToken
            }
        };
